...
const ImageGenerator = () => {
  ...
  const Tooltip = ({ children, title }) => (
    <div className="relative inline-block ml-2 group">
      {children}
      <div className="absolute z-10 invisible group-hover:visible bg-black text-white text-xs rounded p-2 left-0 ml-2 w-48 top-full mt-1">
        {title}
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-white text-black relative">
      <div className="w-full md:w-1/3 p-4 md:p-6 border-b md:border-r border-gray-200 overflow-y-auto">
      ...
      <div className="w-full md:w-2/3 p-4 md:p-6 flex flex-col items-center justify-center bg-gray-100">
        <div className="w-full max-w-[512px] aspect-square bg-gray-300 rounded flex items-center justify-center mb-4">
          {isLoading ? (
